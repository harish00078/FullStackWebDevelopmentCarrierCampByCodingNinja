...
// -> IMP:the dispatch-method basically takes the (action-object) as an argument:and it performs the action on the store:and  updates the state of the application:

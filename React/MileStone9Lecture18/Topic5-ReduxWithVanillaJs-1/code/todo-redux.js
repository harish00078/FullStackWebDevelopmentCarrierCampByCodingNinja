...
// V.IMP-NOTE:here we are creating the (initial-state) or we can say the (current-state) of our application:because through the help of this we are gonna be able to update the state of our application and pass that:

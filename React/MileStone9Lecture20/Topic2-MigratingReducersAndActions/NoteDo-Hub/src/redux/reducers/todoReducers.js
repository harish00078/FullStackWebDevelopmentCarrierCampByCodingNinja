...
const todoSlice = createSlice({
  ...
  // -> The name property is used as a prefix or (first-part) of the (word) for the (action-types) generated by createSlice:

  // IMP:The [second-property]: of the object is the (initial-state):
  // -> The initialState property is used to define the initial state of the slice.
